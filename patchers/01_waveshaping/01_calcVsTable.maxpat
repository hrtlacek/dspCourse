...
,
		...
		"boxes" : [ 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 178.0, 31.0, 6.0, 195.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 290.0, 31.0, 75.0, 20.0 ],
					"text" : "table based"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 22.0, 31.0, 119.0, 20.0 ],
					"text" : "computation based"
				}
...
,
					"patching_rect" : [ 309.0, 124.0, 21.0, 79.0 ],
					"viewvisibility" : 1
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 2,
					"numoutlets" : 0,
					"patching_rect" : [ 215.0, 176.0, 55.0, 22.0 ],
					"text" : "dac~ 1 2"
				}
...
,
						...
						"boxes" : [ 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "float" ],
									"patching_rect" : [ 55.0, 144.0, 32.0, 22.0 ],
									"text" : "tanh"
								}
...
, 							{
								"box" : 								{
									...
									"numinlets" : 3,
									"numoutlets" : 0,
									"patching_rect" : [ 55.0, 174.0, 232.0, 22.0 ],
									"text" : "poke~ table"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 2,
									"outlettype" : [ "int", "int" ],
									"patching_rect" : [ 55.0, 81.0, 125.5, 22.0 ],
									"text" : "t i i"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 55.0, 112.0, 104.0, 22.0 ],
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "bang" ],
									"patching_rect" : [ 18.0, 15.0, 58.0, 22.0 ],
									"text" : "loadbang"
								}
...
,
					"patching_rect" : [ 310.0, 61.0, 96.0, 22.0 ],
					"saved_object_attributes" : 					{
						"description" : "",
						"digest" : "",
						"globalpatchername" : "",
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 314.0, 224.0, 173.0, 20.0 ],
					"text" : "[waveform @buffername table]"
				}
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 335.0, 124.0, 131.0, 96.0 ],
					"setmode" : 4
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "signal" ],
					"patching_rect" : [ 215.0, 129.0, 80.0, 22.0 ],
					"text" : "lookup~ table"
				}
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 310.0, 95.0, 156.0, 22.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "signal" ],
					"patching_rect" : [ 215.0, 78.0, 66.0, 22.0 ],
					"text" : "cycle~ 100"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "signal" ],
					"patching_rect" : [ 40.0, 124.0, 39.0, 22.0 ],
					"text" : "tanh~"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 2,
					"numoutlets" : 0,
					"patching_rect" : [ 40.0, 172.0, 35.0, 22.0 ],
					"text" : "dac~"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "signal" ],
					"patching_rect" : [ 40.0, 78.0, 66.0, 22.0 ],
					"text" : "cycle~ 100"
				}
