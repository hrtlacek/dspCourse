...
\begin{equation}
	y(t) = cos(a \cdot cos(b))
\end{equation}

This really is a simplification, but the overall structure of the formula is correct. FM is mathematically very similar to phase modulation. Looking at figure \ref{fig:fmIdea} we can see the very basic idea implemented in pure data.
\begin{figure}[H]
	\begin{center}
...
We can use exapnd the patcher by adding some math to make it more usable, as in figure \ref{fig:fmNaive}.
