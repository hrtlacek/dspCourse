...
(youtube \glqq{}The Secret to Levitation\grqq{})
	\begin{center}
		...
		\captionof{figure}{Spacial aliasintg in graphics. The ``frequency'' of the intended pixels is to high for the actual pixels.}
		\label{fig:spAlias}
	\end{center}
...
% \begin{center}
%   \includegraphics[width=\textwidth]{photoshop.png}
