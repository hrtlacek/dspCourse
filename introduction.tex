...
This document is in the process of transporting most plots to interactive Collab Notebooks \link{https://colab.research.google.com/notebooks/welcome.ipynb}{Collab Notebooks} where one can see how the plot is made using python and one can play around with the settings interactively.
...
You can look at how these signals where generated and plotted \link{https://colab.research.google.com/drive/10NRGmmLRGxy\_3j7ecGKcME0gkQKmCDOW}{in this Notebook}
