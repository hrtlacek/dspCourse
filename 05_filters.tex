...
\begin{figure}[H]
	...
	\caption[shortCaption]
	{Evaluation of the Transfer function in the complex plane. The unit circle is visible as a dotted line.}
	\label{fig:label}
\end{figure}
...
$cos(\omega) + i\cdot sin(\omega)$. Ths is the same as looking at the values along the dotted line. We can now plot the magnitude response over $\omega$. So we effectively evaluate the formula
\begin{equation}
